<template>
  <div class="wallet-logs-container">
    ...
    <el-form :inline="true" :model="filters" class="filter-form">
      ...
      <el-form-item label="支付类型">
        <el-select v-model="filters.type" placeholder="全部">
          <el-option label="全部" value="0"></el-option>
          <el-option label="商品支付" value="1"></el-option>
          ...
          <el-option label="缴费支付" value="6"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
    ...
    <el-table :data="logs" stripe class="full-width-table" v-loading="loading">
      ...
      <el-table-column prop="amount" label="操作金额" align="center"></el-table-column>
      <el-table-column prop="status" label="操作结果" align="center">
        <template #default="{ row }">
          <el-tag type="success" class="result-tag">成功</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="timestamp" label="操作时间" align="center"></el-table-column>
    </el-table>
