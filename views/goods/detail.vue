<template>
          ...
          <el-card :body-style="{ padding: '0px' }">
              ...
              <div class="block" style="margin-top:0px">
                  ...
                  <div class="image-list-container">
                      <i class="el-icon-arrow-left" @click="moveLeft" style="color: black;"></i>
                      <!-- 显示当前索引范围内的图片 -->
                      <el-row :gutter="20">
                          <el-col :span="6" v-for="(imageSrc, index) in displayImages" :key="index">
                              <el-image :src="imageSrc" fit="fill" class="image-list-item"
                                  @click="selectImage(index + startIndex)"></el-image>
                          </el-col>
                      </el-row>
                      <i class="el-icon-arrow-right" @click="moveRight" style="color: black;"></i>
                  </div>
              </div>
          </el-card>
      </el-aside>
      <el-main style="padding:0px;margin-left: 20px;">
          ...
          <div class="product-main">
              <p class="product-price" style="margin-left:20px;">门店价格：<span
                      style="color: red;font-weight: bold;font-size: 25px;">￥{{ price }}</span></p>
          ...
          <div class="control-container">
              ...
              <el-select style="margin-left: 10px;" v-model="selectedSubOption" filterable placeholder="请选择">
  ...
  <el-form ref="form" :model="form" label-width="80px" class="custom-form">
      <el-tabs v-model="activeName">
          <el-tab-pane label="商品详情"style="font-size: 18px;" name="first"><div class="editor-content" v-html="content" /></el-tab-pane>
      </el-tabs>
  </el-form>
</div>
</template>
